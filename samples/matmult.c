...
int A[SIZE][SIZE] __attribute__ ((aligned(4096))), B[SIZE][SIZE] __attribute__ ((aligned(4096))), C[SIZE][SIZE] __attribute__ ((aligned(4096)));
pthread_barrier_t barr __attribute__ ((aligned(4096)));
